    ...
    <div>
      ...
      <div className="flex flex-col gap-4 p-4">
        ...
        <Card className="overflow-hidden p-0">
          <MapboxMap center={center} zoom={14} markers={markers} interactive={false} className="h-56 w-full" />
        </Card>
                  ...
                  <div key={step.key} className="flex items-center gap-3">
                    <div
                      className={cn(
                        ...
                        done ? 'bg-brand-600 text-white' : active ? 'bg-brand-100 text-brand-600' : 'bg-slate-100 text-slate-300',
                      )}
                    >
        ...
        {request.provider && (
          <Card>
            <CardContent className="flex items-center justify-between gap-3 pt-4">
              <div>
                <p className="font-medium text-slate-900">{request.provider.business_name}</p>
        ...
        <Card>
          <CardContent className="flex flex-col gap-2 pt-4 text-sm">
            <div className="flex justify-between">
              ...
              <span className="max-w-[60%] text-right font-medium text-slate-900">{request.pickup_address}</span>
            </div>
            <div className="flex justify-between">
            ...
            {request.description && (
              <div className="flex flex-col gap-1 border-t border-slate-100 pt-2">
                ...
                <span className="text-slate-700">{request.description}</span>
              </div>
            )}
          </CardContent>
        </Card>
